...
class CardOrdens extends StatefulWidget {
  final Ordem ordem;
  const CardOrdens({Key? key, required this.ordem}) : super(key: key);

  @override
  State<CardOrdens> createState() => _CardOrdensState();
}

class _CardOrdensState extends State<CardOrdens> {
